...
using TweetSentimentAppML.Model;

namespace TweetSentimentAppML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Projects\Presentations\TestData\Sentiment140_trainingandtestdata\training.800000.processed.noemoticon.csv";
        private static string MODEL_FILEPATH = @"../../../../TweetSentimentAppML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Text.FeaturizeText("Tweet_tf", "Tweet")
